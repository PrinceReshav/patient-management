...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "xm3L21Uz4jkRgzZzQfPLpR4BnkkuPpVQwIUfr/kQ3zY="));
    ...
    // ECS Service deployed inside of  below ECS_Cluster can register itself with name to give that service
    //a user friendly address that we can reference in other parts of the code,this address won't change.
    // Ex: Billing Service once deployed in this ECS Cluster will register itself as part of service discovery
    //  billing-service.patient-management.local  => urls will work for internal DNS discovery :
    ...
    private FargateService createFargateService(String id,
        ...
        return FargateService.Builder.create(this, id)
                ...
                .cloudMapOptions(CloudMapOptions.builder()
                        .name(imageName) // name of service going to be registered in CloudMap
    ...
    private ApplicationLoadBalancedFargateService createGrafanaService() {
        ...
        FargateTaskDefinition taskDefinition = FargateTaskDefinition.Builder
                .create(this, "GrafanaServiceTask")
                .cpu(256)
                .memoryLimitMiB(512)
                .build();

        taskDefinition.addContainer("GrafanaContainer",
                ContainerDefinitionOptions.builder()
